...
- [ ] **74.1** **`_seedParameters` (`lib/bloc/spell_creation/spell_creation_bloc.dart`,
      ...
      forbids.
- [ ] **74.2** **This is not theoretical — a passing test already produces it.**
      ...
      10 exists to reject.
- [ ] **74.3** **Why this was deferred rather than folded into check 10/11's fix:**
      ...
      corpus-guard task.
- [ ] **74.4** **Why it is safe today, and not urgent:** nothing silently saves an
      ...
      unnoticed.
- [ ] **74.5** **The pattern to follow, when this is picked up:** the two-way pruning
